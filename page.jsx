      ...
      <div className="max-w-4xl mx-auto">
        <div className="space-y-4 mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Welcome to the official Lizard blog, where you can learn about all things design and read about all the latest magical
            Uizarding news. Whether you are a seasoned pro or a design newcomer, there is something for everyone in the Lizard Blog
            of Spells.
          </p>
        </div>
              ...
              <Card className="overflow-hidden border-0 bg-transparent">
                <CardContent className="p-0 space-y-3">
                  ...
                  <div className="space-y-2">
                    <h2
                      className="font-semibold text-xl group-hover:text-blue-500 transition-colors">
                      {post.title}
                    </h2>
