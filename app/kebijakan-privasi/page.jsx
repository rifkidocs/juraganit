...
async function getPrivacyContent() {
  ...
  const res = await fetch(`${apiUrl}/api/kebijakan-privasi`);
...
export default async function PrivacyPage() {
  const privacyContent = await getPrivacyContent();
  const readTimeMinutes = calculateReadTime(privacyContent.content);
            ...
            <header className='mb-8'>
              ...
              <div className='flex flex-wrap items-center gap-4 text-sm text-muted-foreground'>
                <div className='flex items-center gap-1'>
                  ...
                  <span>{formatDate(privacyContent.publishedAt)}</span>
                </div>
                <div className='flex items-center gap-1'>
